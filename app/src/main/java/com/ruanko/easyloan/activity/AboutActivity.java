    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.ll_card_about_2_email:
                ...
                intent.setData(Uri.parse("mailto:i@panjunwen.com"));
                intent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.about_email_intent));
                //intent.putExtra(Intent.EXTRA_TEXT, "Hi,");
                try {
                    startActivity(intent);
                } catch (Exception e) {
                    Toast.makeText(AboutActivity.this, "没有找到邮箱客户端", Toast.LENGTH_SHORT).show();
                }
                break;

            case R.id.ll_card_about_2_git_hub:
                intent.setData(Uri.parse("https://github.com/Ruanko/Easy-loan"));
            ...
            case R.id.fab_about_share:
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "我在用软酷E贷，你也来用吧！");
